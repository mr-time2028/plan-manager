...
class WorkspaceView(viewsets.ModelViewSet):
    ...
    def create(self, request):
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            self.send_task_email(serializer.instance, "created")
    ...
    def update(self, request, slug=None):
        ...
        if serializer.is_valid(raise_exception=True):
            serializer.save()
            self.send_task_email(serializer.instance, "update")
            return Response(serializer.data, status=status.HTTP_200_OK)
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
    ...
    def destroy(self, request, slug=None):
        ...
        send_mail(
                  ...
                  message='The task "delete" has been deleted.',
                  recipient_list=['mahdioruji8180@gmail.com']
                  )
